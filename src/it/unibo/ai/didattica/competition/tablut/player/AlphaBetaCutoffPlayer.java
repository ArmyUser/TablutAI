...
public class AlphaBetaCutoffPlayer extends AIPlayer{
    ...
    public AlphaBetaCutoffPlayer(Game game, HistoryCommandHandler handler, int maxDepth, String player, int timeout ) {
        super( new AlphaBetaCutoffAlgorithm(game,handler,maxDepth,player, timeout) );
    }
